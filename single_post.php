...
<html lang="en">
  <head>
    ...
    <title>Single post page- SE NEWS</title>
    <link
      rel="shortcut icon"
  ...
  <body>
    ...
    <header
      class="masthead"
      style="background-image: url('assets/img/post1.jpg')"
    >
        ...
        <div class="row">
          <div class="col-md-10 col-lg-8 mx-auto position-relative">
            <div class="post-heading">
              ...
              <span class="meta"
                >Posted by&nbsp;<a href="#">Samin eyaser</a>&nbsp;on March 24,
                2023</span
              >
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-lg-8 mx-auto">
            ...
            <a href="#"
              ><img
                class="img-fluid"
                src="assets/img/post-sample-image.jpg" /></a
        ...
        <form action="" class="card border-0">
          ...
          <input
            type="submit"
            value="post"
            class="btn btn-primary w-25 mx-auto d-block my-2"
          />
        </form>
      </div>
    </article>
